        ...
        <div className='container mt-5 mb-4 text-center text-md-left'>
          <div className='row mt-3'>
            ...
            <div md='4' lg='4' xl='2' className='col mb-4'>
              ...
              <hr className='light-green accent-3 mb-4 mt-0 d-inline-block mx-auto' style={{ width: '60px' }} />
              <span className='badge badge-pill green'>React</span>
              <span className='badge badge-pill green'>MySql</span>
              <span className='badge badge-pill green'>MD Bootstrap</span>
              <span className='badge badge-pill green'>JavaScript</span>
            </div>
          </div>
        </div>
