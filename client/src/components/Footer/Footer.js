        ...
        <div className='container mt-5 mb-4 text-center text-md-left'>
          <div className='row mt-3'>
            ...
            <div md='4' lg='4' xl='2' className='col mb-4'>
              ...
              <hr className='light-green accent-3 mb-4 mt-0 d-inline-block mx-auto' style={{ width: '60px' }} />
              <div>
                <a href='https://reactjs.org/' className='badge badge-black'>React</a>
                <a href='https://nodejs.org/en/' className='badge badge-black'>Node.js</a>
                <a href='https://expressjs.com/' className='badge badge-black'>Express</a>
                <a href='https://www.mysql.com/' className='badge badge-black'>MySQL</a>
                <a href='http://docs.sequelizejs.com/' className='badge badge-black'>Sequelize</a>
                <a href='https://mdbootstrap.com/components' className='badge badge-black'>Material Design for React Bootstrap</a>
                <a href='https://aws.amazon.com/?nc2=h_lg' className='badge badge-black'>Amazon Web Services</a>
                <a href='#http://www.passportjs.org/' className='badge badge-black'>Passport.js</a>
                <a href='https://www.semantics3.com/' className='badge badge-black'>Semantic3</a>
                <a href='#!' className='badge badge-black'>Zebra Crossing</a>
              </div>
            </div>
          </div>
        </div>
